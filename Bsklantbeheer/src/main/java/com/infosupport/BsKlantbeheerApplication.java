...
//
//            Customer customer1 = Customer.builder().firstName("Sander").lastName("Blijlevens").email("SB@hotmail.com").birthDate("2017-01-05").credit(200).addresses(Arrays.asList(address1,address2)).build();
