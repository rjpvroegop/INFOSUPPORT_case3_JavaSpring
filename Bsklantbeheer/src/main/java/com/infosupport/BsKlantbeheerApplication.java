...
public class BsKlantbeheerApplication {
    ...
    CommandLineRunner onStartUp(CustomerRepository customerRepository, AddressRepository addressRepository, WebshopAccountRepository webshopAccountRepository) {
        return (String... args) -> {
            ...
            Customer customer1 = Customer.builder().firstName("Sander").lastName("Blijlevens").email("SB@hotmail.com").birthDate("1993-1-2").credit(200).addresses(Arrays.asList(address1,address2)).build();
            Customer customer2 = Customer.builder().firstName("Kenzo").lastName("Dominicus").email("KD@gmail.com").birthDate("1994-1-1").credit(300).build();
            Customer customer3 = Customer.builder().firstName("Randy").lastName("Vroegop").email("RV@gmail.com").birthDate("1995-2-13").credit(300).build();
            Customer customer4 = Customer.builder().firstName("Yusuf").lastName("Yusuf").email("YY@outlook.com").birthDate("1996-1-21").credit(300).build();
            Customer customer5 = Customer.builder().firstName("Maarten").lastName("van den Broek").email("MB@yahoo.com").birthDate("1993-1-16").credit(300).build();
